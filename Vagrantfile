...
Vagrant.configure(2) do |config|
  ...
  config.vm.network :forwarded_port, guest: 22, host: 2223 #, id: "ssh", disabled: false
  ...
  # config.vm.synced_folder ".", "/api", type: "smb" #use this in place of default /vagrant start admin command and run vagrant up in windows
